...
function Main() {
    ...
    const files = [
        ...
        new File( "file7"  , "Online order form"                         , "Sites/FinalProject2/index.html"                 , "Home_Assets/InternetExplorerIcon.png", "Simple page that uses JS to calculate totals from selected items."                                                                        ),
        new File( "file8"  , "NASA's API.exe"                            , "Sites/SamsJSproject11/index.html"               , "Home_Assets/ApplicationIcon.png"     , "Webpage that uses NASA's API to show you pictures they took on specific dates."                                                           ),
        new File( "file9"  , "Temperature Converter.exe"                 , "Sites/SamsJSproject2/index.html"                , "Home_Assets/ApplicationIcon.png"     , "Simple JS project that targets input fields and manipulates the values."                                                                  ),
        new File( "file10" , "Time Converter.exe"                        , ""                                               , "Home_Assets/ApplicationIcon.png"     , "Experimenting with time manipulation in javaScript."                                                                                      ),
        new File( "file11" , "TimerStopwatch.exe"                        , ""                                               , "Home_Assets/ApplicationIcon.png"     , "Simple timer and stopwatch function."                                                                                                     ),
        new File( "file12" , "Timed math quiz"                           , "Sites/SamsJSproject5/index.html"                , "Home_Assets/InternetExplorerIcon.png", "JS project that compares inputs with declared values and manipulates the HTML page to give the user feedback."                            ),
        new File( "file13" , "Input validation"                          , "Sites/SamsJSproject7/index.html"                , "Home_Assets/InternetExplorerIcon.png", "This script demonstrates how to use JS to restrict user inputs."                                                                          ),
        new File( "file14" , "Stopwatch"                                 , "Sites/SamsJSproject8/index.html"                , "Home_Assets/InternetExplorerIcon.png", "Webpage that uses NASA's API to show you a picture taken on a specified date."                                                            ),
